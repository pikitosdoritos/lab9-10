...
#
# 1) ВВП та населення країн ЄС
# 2) ВВП на душу населення та середня тривалість життя
# ======================================================================
...
# ======================================================================
# ЗАВДАННЯ 7
# Використання бібліотеки Seaborn
# ======================================================================

print("=" * 80)
print("ЗАВДАННЯ 7")
print("Побудова графіка за допомогою Seaborn")
...
print("=" * 80)
print("Побудова графіка за допомогою Plotly")
